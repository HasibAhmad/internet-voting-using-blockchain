                      ...
                      <div class="row">
                          ...
                          <div class="col-sm-7">
                              <div class="form-group{{ $errors->has('election_id') ? ' has-danger' : '' }}">
                                  <input class="form-control{{ $errors->has('election_id') ? ' is-invalid' : '' }}" name="election_id" id="input-election_id" type="text" placeholder="{{ __('election_id') }}" required="true" aria-required="true"/>
                                  @if ($errors->has('election_id'))
                                      <span id="election_id-error" class="error text-danger" for="input-election_id">{{ $errors->first('election_id') }}</span>
                                  @endif
                              </div>
                          </div>
                      </div>
