                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('private_key') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('private_key') ? ' is-invalid' : '' }}" name="private_key" id="input-name" type="text" placeholder="{{ __('private_key') }}" value="{{ old('private_key', $voter->private_key) }}" required="true" aria-required="true"/>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <div class="form-group{{ $errors->has('bitcoin_address') ? ' has-danger' : '' }}">
                                <input class="form-control{{ $errors->has('bitcoin_address') ? ' is-invalid' : '' }}" name="bitcoin_address" id="input-bitcoin_address" type="text" placeholder="{{ __('bitcoin_address') }}" value="{{ old('private_key', $voter->bitcoin_address) }}" required="true" aria-required="true"/>
